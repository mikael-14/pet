...
class DewormingPolicy
{
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function view(User $user, Deworming $deworming)
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function update(User $user, Deworming $deworming)
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function delete(User $user, Deworming $deworming)
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function forceDelete(User $user, Deworming $deworming)
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function restore(User $user, Deworming $deworming)
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function replicate(User $user, Deworming $deworming)
    {
